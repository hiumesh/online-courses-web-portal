...
export default function SignInUI() {
  ...
  const [passwordResetEmail, setPasswordResetEmail] = useState<null | string>(
    null
  );
      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden py-6 sm:py-12 bg-white">
        <div className="max-w-xl px-5 text-center">
          ...
          <p className="mb-2 text-lg text-zinc-500">
            Your Forgot password request accecpted and we have sent an password
            reset link to your email i.e{" "}
          ...
          <Link
            href="/"
            className="mt-3 inline-block w-96 rounded bg-primary-button px-5 py-3 font-medium text-white shadow-md shadow-indigo-500/20"
          >
            Go back →
          </Link>
        </div>
        ...
        <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <div className="flex justify-between gap-1">
              <button
                className="flex gap-2 items-center bg-slate-100 rounded  border px-3 py-1 text-sm hover:bg-slate-200"
              ...
              <button className="flex gap-1 items-center bg-slate-100 rounded  border px-3 py-1 text-sm hover:bg-slate-200">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="30"
                  height="30"
            ...
            >
              ...
              <div className="flex items-center justify-end">
                <button
                  ...
                  className="flex items-center gap-1 text-sm font-medium text-primary-600 disabled:cursor-not-allowed disabled:text-gray-600 hover:underline dark:text-primary-500"
                >
                  {forgotPassLoading && (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
